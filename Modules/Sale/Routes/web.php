...
Route::group(['middleware' => 'auth'], function () {
    ...
    //Payments
    Route::get('/sale/dispatch/{id}', 'SalePaymentsController@dispatch')->name('sales.dispatch');
    Route::get('/sale-return/dispatch/{id}', 'SalePaymentsController@dispatch_store')->name('sales-return.dispatch');
