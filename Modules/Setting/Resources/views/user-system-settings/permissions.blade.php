                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[1]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="show_notifications"
                            ...
                            <div class="col-12">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[2]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="show_month_overview"
                            ...
                            <div class="col-12">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[3]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-12">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[4]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[5]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="access_products"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[6]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="show_products"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[7]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="create_products"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[8]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_products"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[9]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="delete_products"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[10]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[11]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[12]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[13]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="show_adjustments"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[14]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_adjustments"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[15]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[16]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="access_expenses"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[17]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="create_expenses"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[18]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_expenses"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[19]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="delete_expenses"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[20]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[21]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="access_customers"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[22]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="create_customers"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[23]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="show_customers"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[24]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_customers"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[25]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="delete_customers"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[26]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="access_sales"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[27]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="create_sales"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[28]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_sales"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[29]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="delete_sales"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[30]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="create_pos_sales"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[31]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[32]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[33]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[34]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[35]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[36]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[37]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[38]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="access_purchases"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[39]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="create_purchases"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[40]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="show_purchases"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[41]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_purchases"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[42]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="delete_purchases"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[43]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[44]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[45]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[46]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[47]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[48]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[49]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                                        id="access_purchase_return_payments" name="permissions[]" value="66">
                                    <label class="custom-control-label"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[50]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[51]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[52]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="edit_currencies"
                                        name="permissions[]" value="70">
                                    <label class="custom-control-label" for="edit_currencies">Edit</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[53]->status === 'true' ? 'checked' : '' }} class="custom-control-input"
                ...
                <div class="card h-100 border-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ $userpermissions[54]->status === 'true' ? 'checked' : '' }} class="custom-control-input" id="access_reports"
                                        name="permissions[]" value="67">
