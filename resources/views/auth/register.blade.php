    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <form method="post" action="{{ url('/register') }}">
                        ...
                        <div class="card">
                            <div class="card-body">  
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-primary float-right permissionBtn">Continue</button>
                                </div>
                ...
                <div class="col-md-6 registrationForm d-none">
                    <div class="card mx-4 ">
                        @csrf
                        <div class="card-body p-4 ">
                           ...
                           <div class="row">
                            <div class="col-12 col-md-6"> <button type="button" class="backtoPermission btn btn-block btn-flat mb-3 btn-outline-success text-dark"><i class="fa fa-chevron-left mr8"></i> Change Permissions</button></div>
                            <div class="col-12 col-md-6"> <button type="submit" class="btn btn-primary btn-block btn-flat mb-3">Register</button></div>
                           </div>
