...
{{--                                   name="email" value="super.admin@test.com"--}}
{{--                                   placeholder="Email">--}}
{{--                            @error('email')--}}
...
{{--                                   class="form-control @error('password') is-invalid @enderror" value="12345678"--}}
                ...
                <form class="login-form" action="{{ url('/login') }}" method="post">
                    ...
                    <div class="form-label">
                        ...
                        <input type="email" name="email" id="email" required placeholder="Email"
                               class="@error('email') is-invalid @enderror" value="super.admin@test.com">
                        @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-label">
                        ...
                        <input type="password" name="password" id="pwd" required placeholder="Password"
                               class="@error('password') is-invalid @enderror" value="12345678">
                        @error('password')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="cta-container">
                        ...
                        <div class="login-link">
                            <span class="psw"><a href="{{ route('register')}}">Don't have an account?</a></span>
                            <span class="psw"><a href="{{ route('password.request') }}">Reset password?</a></span>
                        </div>
                    </div>
                </form>
            </div>
